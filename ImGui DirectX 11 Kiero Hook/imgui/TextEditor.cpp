...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
{
	...
	if (!inited)
	{
		...
		static const char* const identifiers[] = {
			"assert", "collectgarbage", "dofile", "error", "getmetatable", "ipairs", "loadfile", "load", "loadstring",  "next",  "pairs",  "pcall",  "rawequal",  "rawlen",  "rawget",  "rawset",
			...
			"coroutine", "table", "io", "os", "string", "utf8", "bit32", "math", "debug", "package", "MB_ICONERROR", "MB_ICONWARNING", "MB_ICONQUESTION", "MB_ICONINFORMATION", "MB_YESNO", "MB_YESNOCANCEL", "MB_RETRYCANCEL",
			"MB_OK", "IDYES", "IDNO", "IDCANCEL", "IDRETRY", "VK_ESCAPE", "VK_TAB", "VK_CAPITAL", "VK_SHIFT", "VK_CONTROL", "VK_MENU", "VK_XBUTTON1", "VK_XBUTTON2", "VK_F1", "VK_F2", "VK_F3", "VK_F4", "VK_F5" , "VK_F6",
			"VK_F7", "VK_F8", "VK_F9", "VK_F10", "VK_F11", "VK_F12", "VK_F13", "VK_F14", "VK_F15", "VK_F16", "VK_F17", "VK_F18", "VK_F19", "VK_F20", "VK_F21", "VK_F22", "VK_F23", "VK_F24", "VK_HOME", "VK_DELETE", "VK_INSERT",
			"VK_END", "VK_SPACE", "VK_SCROLL", "VK_LBUTTON", "VK_RBUTTON", "VK_RETURN", "VK_NONE", "_WIN_SIZE_X", "_WIN_SIZE_Y", "_WIN_CENTER_X", "_WIN_CENTER_Y", "__MENU_VERSION", "__GAME_VERSION", "Enable", "Disable",
			"gui", "MessageBoxA", "MessageBoxW", "MessageBoxExA", "Checkbox", "Button", "Hotkey", "Text", "FloatSlider", "IntSlider", "InputFloat", "InputInt", "InputText", "Spacing", "Separator", "SameLine", "SetNextItemWidth",
			"draw", "AddLine", "AddRect", "AddFilledRect", "AddCircle", "AddFilledCircle", "AddText", "WorldToScreen", "LP", "AimAtPos", "_IN_GAME", "MOUSEEVENTF_MOVE", "MOUSEEVENTF_MOVE_NOCOALESCE", "MOUSEEVENTF_ABSOLUTE",
			"MOUSEEVENTF_HWHEEL", "MOUSEEVENTF_LEFTDOWN", "MOUSEEVENTF_WHEEL", "MOUSEEVENTF_LEFTUP", "MOUSEEVENTF_RIGHTDOWN", "MOUSEEVENTF_RIGHTUP", "MOUSEEVENTF_MIDDLEDOWN", "MOUSEEVENTF_MIDDLEUP", "MOUSEEVENTF_XDOWN",
			"MOUSEEVENTF_XUP", "MOUSEEVENTF_VIRTUALDESK", "GetMouse", "SetMouse", "MouseEvent", "IsKeyDown",  "IsKeyPressed", "game", "GetAlivePlayers", "getPos", "getBonePos", "getRot", "Color", "getTrm", "setSpeed",
			"mem", "readPtr", "reaInt", "readFloat", "readByte", "readString", "readVec2", "readVec3", "readMBPtr", "readTrmPtr", "isValidPtr", "writePtr", "writeInt", "writeFloat", "writeByte", "writeString", "writeVec2",
			"writeVec3", "getGameObject", "setRot", "setPos", "getStaticPtr", "writeStruct", "readStruct", "CallFunc", "Cast", "getMB", "_GAME_ASSEMBLY",
			"menu", "SetFeature", "GetFeature", "VK_NUMPAD0", "VK_NUMPAD1", "VK_NUMPAD2", "VK_NUMPAD3", "VK_NUMPAD4", "VK_NUMPAD5", "VK_NUMPAD6", "VK_NUMPAD7", "VK_NUMPAD8", "VK_NUMPAD9", "getVel", "setVel",
			"getAngularVel", "setAngularVel", "getDrag", "setDrag", "setAngularDrag", "setMass", "setUseGravity", "getIsKinematic", "setIsKinematic", "addForce", "getRigidbody", "isAlive", "Combo",
			"SetKey", "KEYEVENTF_KEYUP", "KEYEVENTF_KEYDOWN", "KEYEVENTF_EXTENDEDKEY", "KEYEVENTF_SCANCODE", "KEYEVENTF_UNICODE", "getCamTransform", "LUDtoINT", "GetAllPlayers", "getId", "getPlayerNum", "GetObjectOfType",
			"GetHostId", "Raycast"
		};
